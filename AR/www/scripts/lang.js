...
function Translator() {
    ...
    this.speakTextUsingGoogleSpeaker = function (args) {
        ...
        var audio_url = 'https://translate.google.com/translate_tts?ie=UTF-8&total=1&idx=0&textlen=' + Translator.speakTextUsingGoogleSpeaextToSpeak + '&tl=' + targetLanguage + '&q=' + textToSpeak;
        ...
        if (args.callback) args.callback(audio_url);
            ...
            audio.onerror = function (event) {
                audio.onerror = null;
                audio.src = 'https://translate.google.com/translate_tts?ie=UTF-8&total=1&idx=0&textlen=' + textToSpeak + '&tl=' + targetLanguage + '&q= ' + textToSpeak;
            };
            audio.src = audio_url;
            audio.autoplay = true;
            audio.play();
    ...
    this.translateLanguage = function (text, config) {
        ...
        var api_key = 'AIzaSyBCjpVVEKoGocO1zZEdQQ0Ifw7ypsOeU-8';
    ...
    var Google_Translate_API_KEY = 'AIzaSyBCjpVVEKoGocO1zZEdQQ0Ifw7ypsOeU-8';
}
